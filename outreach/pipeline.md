...
- **2026-05-13** : Reply Tracker run automatique — 0 SLOT LIBÉRÉ auto, 4 canaux alt signalés (G'sell, Salathé, d'Agrain, Distinguin), 3 alertes EN COURS HUMAIN (Stefanini, Iteanu, Hubert). ⚠️ Désynchro pipeline détectée (196h sans MAJ depuis v6.0 du 04/05).
