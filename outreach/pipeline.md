...
Objectif: 5 Design Partners signés. Statut actuel: **0/5 signés. 0 fil frais (Gesnouin → SLOT LIBÉRÉ 11/09, réserve institution publique cf. changelog v7.2). 2 fils dormants (Alexandra Iteanu — reprise autorisée ; Gabriel Hubert — optionnel). 1 veille passive (Stefanini). 3 PROPOSÉ stagnants depuis le batch du 04/07 (Hadj, Boutemadja/Klaimee, MACSF) — aucun n'est parti au 11/09.**
...
## Slots libérés (silence total >35j)

**Purge 04/07 (v7.0)** : Erdem Yağan (Remedi), Juliette Mattioli (Thales), Ian Rogers (Ledger), Aldrick Zappellini (Crédit Agricole), David Rice (HSBC), Stanislas Polu (Dust), Florence G'sell (Sciences Po), Marcel Salathé (EPFL), Christine Balagué (IMT-BS), Vincent Strubel (ANSSI), Anne Bouverot (AI Action Summit), Cédric O, Henri d'Agrain (Cigref), Tariq Krim, Stéphane Distinguin (Fabernovel) — 15 contacts.

**Ajout tracker 11/09 (v7.2)** : Philippe Gesnouin (Inria) — 58j silence après email 15/07 (cc Sportisse). Remplaçant à proposer par Outreach Radar W38. ⚠️ RÉSERVE INSTITUTION PUBLIQUE : la leçon Sportisse (réponse à ~2,5 mois) indique que les institutions publiques répondent en temps long. Le passage automatique 35j est appliqué mécaniquement par le tracker, mais Audric peut ré-évaluer manuellement s'il souhaite conserver le fil réputationnel plus longtemps — dans ce cas, restaurer statut ENVOYÉ + note "conservé sciemment >35j (institution publique)". Aucun canal alt possible : le cc Sportisse interdit toute insistance. Silence = silence, seul choix = laisser dormir ou libérer.

Bruno Sportisse, initialement dans la purge 04/07, en est SORTI le 15/07 (réponse reçue) : leçon — les institutions publiques répondent à 2-3 mois, la règle 35j est calibrée pour le privé.
...
- Signés : **0 / 5**
- Fil frais : **0** (Gesnouin passé SLOT LIBÉRÉ 11/09 — réserve institution publique)
- Fils dormants : 2 (Iteanu — reprise autorisée ; Hubert — optionnel)
- Envois planifiés : 3 (Hadj 16-17/07 ; Klaimee 20/07 ; MACSF semaine du 20/07) — **⚠️ tous PROPOSÉ depuis ~53-56j, aucun n'est parti. À statuer : envoyer OU SKIP.**
- Veille passive : 1 (Stefanini)
- Règle capacité : **3 fils chauds simultanés max**. Un envoi à la fois — le batch du 04/07 (4 envois planifiés d'un coup) n'a produit aucun envoi en 11 jours au 15/07, situation reconduite au 11/09 (~55j de plus).
...
| **2026-07-16 ou 17** | Envoi LinkedIn Hadj (vérifier bouton Message avant). ⚠️ non exécuté au 11/09. |
| **2026-07-20 (lundi)** | Envoi email Boutemadja/Klaimee (adresse validée Hunter ≥80 d'abord). ⚠️ non exécuté au 11/09. |
| **Semaine du 20/07** | Courrier MACSF sociétaire. ⚠️ non exécuté au 11/09. |
...
| **2026-07-31** | Si silence Hadj 14j → canal alt contact.dataprivacy@doctolib.com. (sans objet : Hadj jamais parti) |
| **2026-08-31** | Jalon : template agent-sante-rgpd shippé + brouillon texte de référence mandat/responsabilité. |
| **2026-09-11** | Passage tracker : Gesnouin → SLOT LIBÉRÉ (58j silence, règle 35j appliquée, réserve institution publique). |
...
- **2026-09-11 (v7.2)** : passage tracker automatique. Gesnouin → SLOT LIBÉRÉ (58j silence email, règle 35j appliquée) — avec réserve institution publique (leçon Sportisse : les institutions publiques répondent à 2-3 mois). Aucun autre changement de statut. Alertes signalées dans la PR : 3 PROPOSÉ stagnants (Hadj, Boutemadja, MACSF depuis ~53-56j — le batch 04/07 se répète), 3 EN COURS HUMAIN stagnants (Sportisse volontaire cc-clos, Iteanu en attente reconfirmation Audric, Hubert optionnel). Aucun canal alt possible : Gesnouin explicitement interdit (cc Sportisse), les autres ENVOYÉ n'existent pas. Désynchro pipeline détectée à la pré-vérification : dernier commit 2026-07-15, écart ~1375h.
