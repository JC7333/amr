...
| 2026-04-14 | Erdem Yağan | Remedi Finance | Fintech healthcare BNPL (UK/TR) | LinkedIn (EN) puis email 23/04 | **SLOT LIBÉRÉ** | 2026-04-23 (email depuis audric@mandatia.eu) | **Slot libéré 2026-05-23 par Reply Tracker** : 39j silence total (LinkedIn 14/04 + email 23/04, aucune réponse). Échéance interne 18/05 dépassée de 5j. Remplaçant à proposer par Outreach Radar prochain run. CEO Remedi = BNPL cliniques + e-KYC + credit scoring = AI Act Annex III pt 5. Email public vérifié erdem@remedifinance.com. Cooldown 90j maintenu jusqu'au 22/07. |
...
- Canal alt email tenté : 1 (Erdem) → silence → SLOT LIBÉRÉ 23/05
- SLOT LIBÉRÉ : 2 (Gauthier Henroz / Chift — anticipé 04/05 ; Erdem Yağan / Remedi — 23/05)

**FUNNEL RÉEL** : 16 contacts en suivi actif (21 envoyés - Adnan SORTI - Gauthier libéré - Erdem libéré - Houlès SKIP). 3 conversations chaudes dont 1 RDV calé. **STOP nouveaux contacts jusqu'au 18/05** (priorité = cadrer correctement Iteanu + Hubert + Stefanini si elle répond). ⚠️ Note Reply Tracker 23/05 : ce plafond 18/05 est désormais échu (pipeline non synchronisé depuis le 04/05) — Audric à arbitrer.
...
- **2026-05-23 (Reply Tracker)** : Erdem Yağan → SLOT LIBÉRÉ (39j silence total cumulé LinkedIn 14/04 + email 23/04 ; échéance interne 18/05 dépassée). Compteur funnel actif 17 → 16. ⚠️ Avertissement désynchro : pipeline.md non touché depuis le 04/05 (>18 jours) ; le reste du fichier reflète l'état figé du 04/05 et non l'état réel des envois/réponses ultérieurs — synchro manuelle prioritaire.
