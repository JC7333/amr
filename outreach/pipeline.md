...
|---|---|---|---|---|---|---|---|
| 2026-07-15 | **Philippe Gesnouin** | Inria | Directeur programme Santé numérique, co-pilote PEPR Santé numérique (France 2030), cofondateur Health Data Hub | Email audric@mandatia.eu, cc Bruno Sportisse | **SLOT LIBÉRÉ** | 2026-07-15 (email envoyé, version ultra-courte validée) | Slot libéré 2026-09-09 par tracker automatique (silence 55j — règle 35j). Aucun remplaçant à proposer par Outreach Radar W38 (cible réputation/réseau institutionnel, pas DP commercial — donc slot non recyclé côté DP). ⚠️ **ATTENTION Audric** : contact institutionnel Inria. La leçon Sportisse (réponse à ~2,5 mois) suggère que la règle 35j est trop courte pour les institutions publiques. Envisager de repasser en ENVOYÉ manuellement si vous voulez respecter la fenêtre 90j. Silence = silence côté insistance : ne rien relancer côté Gesnouin. |
...
**Ajout 2026-09-09 par tracker automatique** : Philippe Gesnouin (Inria) — silence 55j sur email envoyé le 15/07. ⚠️ Contact institutionnel : la leçon Sportisse s'applique. À réviser manuellement (pas de DP visé, cible réputation).
...
- Signés : **0 / 5**
- Fil frais : **0** (Gesnouin passé SLOT LIBÉRÉ par tracker 09/09 — à réviser)
- Fils dormants : 2 (Iteanu — reprise autorisée ; Hubert — optionnel)
- Envois planifiés : 3 (Hadj 16-17/07 ; Klaimee 20/07 ; MACSF semaine du 20/07) — **NON EXÉCUTÉS au 09/09 selon pipeline, à re-synchroniser**
...
| **2026-09-09** | Tracker automatique : Gesnouin SLOT LIBÉRÉ (à réviser). Désynchro pipeline détectée (55j). |
...
- **2026-09-09 (v7.2)** : Reply Tracker automatique. Gesnouin (Inria) passé en SLOT LIBÉRÉ à 55j de silence email — règle mécanique 35j appliquée. ⚠️ Contact institutionnel : la leçon Sportisse (réponse à 2,5 mois) suggère que la règle 35j est trop courte pour les institutions publiques ; Audric peut repasser en ENVOYÉ manuellement s'il souhaite respecter la fenêtre 90j. **Désynchro majeure détectée** : pipeline non mis à jour depuis 1332h (55j) → toutes les alertes de ce run peuvent être basées sur des données obsolètes ; les 3 statuts PROPOSÉ (Hadj, Boutemadja, MACSF) datent d'envois planifiés le 16-20/07 non tracés comme ENVOYÉ, à re-synchroniser en priorité.
