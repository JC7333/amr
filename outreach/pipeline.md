...
- **2026-07-30 (tracker)** : passage Reply Tracker automatique. ⚠️ Désynchro pipeline détectée (348h / ~14,5j depuis v7.1 le 15/07) — les alertes ci-dessous peuvent porter sur des données obsolètes (les envois recalés 16-17/07, 20/07, semaine 20/07 ne sont pas confirmés dans le fichier). Alertes levées, aucun statut modifié : 3 rappels PROPOSÉ >3j (Boutemadja/Klaimee, Hadj/Doctolib, MACSF) ; 3 stagnants EN COURS HUMAIN (Sportisse — boucle close par cc Gesnouin, no-op assumé ; Iteanu — dormant depuis mai, action = reconfirmer contenu appel avant envoi draft ; Hubert — dormant depuis 29/04, optionnel) ; 0 slot libéré (Gesnouin à 14j seulement) ; 0 canal alt (Gesnouin exclu, cc Sportisse interdit toute insistance).
