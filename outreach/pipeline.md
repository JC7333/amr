...
|---|---|---|---|---|---|---|---|
| 2026-07-15 | **Philippe Gesnouin** | Inria | Directeur programme Santé numérique, co-pilote PEPR Santé numérique (France 2030), cofondateur Health Data Hub | Email audric@mandatia.eu, cc Bruno Sportisse | **SLOT LIBÉRÉ (sous réserve)** | 2026-07-15 (email envoyé, version ultra-courte validée) | **Auto-libéré Reply Tracker 2026-09-22** (silence 69j > 35j). ⚠️ RÉSERVE INSTITUTIONNELLE : la leçon v7.1 documente que les institutions publiques répondent à 2-3 mois — la règle 35j est calibrée pour le privé. **Le pipeline est stale 69j** : possible que Gesnouin ait répondu hors pipeline. Audric à vérifier avant de proposer un remplaçant via Outreach Radar. Contexte d'origine : intro via réponse Sportisse, cc Sportisse, angle SANTÉ pur, pas de relance possible (cc interdit toute insistance). |
...
**Ajout 2026-09-22 (Reply Tracker, sous réserve)** : Philippe Gesnouin (Inria), silence 69j sur email warm intro. À entériner ou révoquer selon la même leçon institutionnelle — voir ligne pipeline actif ci-dessus.
...
- Signés : **0 / 5**
- Fil frais : **0** (Gesnouin auto-libéré Reply Tracker 2026-09-22 après 69j silence, ⚠️ sous réserve institutionnelle — à valider par Audric)
- Fils dormants : 2 (Iteanu — reprise autorisée ; Hubert — optionnel)
- Envois planifiés : 3 (Hadj 16-17/07 ; Klaimee 20/07 ; MACSF semaine du 20/07) — ⚠️ **tous planifiés depuis ~65 jours sans trace d'envoi dans le pipeline. Audric à confirmer envoyés (→ ENVOYÉ + date) ou abandonnés (→ SKIP).**
...
| **2026-09-22** | Reply Tracker : auto-libération Gesnouin (sous réserve), désynchro pipeline signalée à 69j. |
...
- **2026-09-22 (v7.2, Reply Tracker automatique)** : ⚠️ PIPELINE STALE 69j — dernière modif humaine 2026-07-15. Auto-transition Gesnouin ENVOYÉ → SLOT LIBÉRÉ (silence 69j > seuil 35j) MAIS avec réserve institutionnelle (cf. leçon Sportisse v7.1 documentant 2-3 mois de délai pour institutions publiques). Alertes émises dans la PR : 3 rappels PROPOSÉ jamais envoyés (Hadj, Klaimee, MACSF) planifiés depuis juillet ; 3 EN COURS HUMAIN stagnants (Sportisse 69j, Iteanu ~144j, Hubert ~146j). Aucune relance ni draft produit — attente sync manuelle par Audric avant toute action.
