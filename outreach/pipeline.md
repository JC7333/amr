...
| 2026-04-14 | Erdem Yağan | Remedi Finance | Fintech healthcare BNPL (UK/TR) | LinkedIn (EN) puis email 23/04 | **SLOT LIBÉRÉ** | 2026-04-23 (email depuis audric@mandatia.eu) | Slot libéré 2026-05-29 (>35j cumulés de silence total : LinkedIn 14/04 + email 23/04, canal alt déjà tenté, aucune réponse). Remplaçant à proposer par Outreach Radar W22. Les deux canaux épuisés → abandon définitif. CEO Remedi = BNPL cliniques + e-KYC + credit scoring = AI Act Annex III pt 5. |
...
| 2026-04-22 | Juliette Mattioli | Thales | Défense / tech souveraine (CAC40) | LinkedIn direct | **SLOT LIBÉRÉ** | 2026-04-22 | Slot libéré 2026-05-29 (37j silence total, aucune réponse), remplaçant à proposer par Outreach Radar W22. Aucune tentative email effectuée : envisager email juliette.mattioli@thalesgroup.com (94,5%, valider Hunter) avant abandon définitif — cible à haute valeur (CAC40). Canal alt jamais activé. |
| 2026-04-22 | Ian Rogers | Ledger | Fintech sécurité hardware | LinkedIn note connexion 193c | **SLOT LIBÉRÉ** | 2026-04-22 | Slot libéré 2026-05-29 (37j silence total, aucune réponse), remplaçant à proposer par Outreach Radar W22. Aucune tentative email : envisager ian.rogers@ledger.com (72,9%) ou @ledger.fr (51,2%) (valider Hunter) avant abandon définitif — cible à haute valeur. Profil fermé. |
| 2026-04-22 | Aldrick Zappellini | Groupe Crédit Agricole | Banque mutualiste | LinkedIn InMail | **SLOT LIBÉRÉ** | 2026-04-22 | Slot libéré 2026-05-29 (37j silence total, aucune réponse), remplaçant à proposer par Outreach Radar W22. Aucune tentative email : envisager aldrick.zappellini@credit-agricole.com (89%, valider Hunter) avant abandon définitif — cible à haute valeur. |
| 2026-04-22 | David Rice | HSBC | Banque universelle (UK) | LinkedIn InMail | **SLOT LIBÉRÉ** | 2026-04-22 | Slot libéré 2026-05-29 (37j silence total, aucune réponse), remplaçant à proposer par Outreach Radar W22. Aucune tentative email : envisager david.rice@hsbc.com (71%, risque doublon nom, valider Hunter) avant abandon définitif — cible à haute valeur. |
...
- Signés: **0 / 5**
- **Conversations actives** : **3 chaudes** (Alexandra Iteanu, Gabriel Hubert, Rémi Stefanini) — ⚠️ les 3 sont en EN COURS HUMAIN **sans mise à jour visible depuis >30j** (pipeline non synchronisé depuis le 04/05 ; voir alertes Reply Tracker 2026-05-29).
- **Reclassement partner LT** : 1 (Adnan Khan / Centurian)
- Messages ENVOYÉS sans retour : 11 (Polu, G'sell, Salathé, Balagué, Strubel, Bouverot, Cédric O, d'Agrain, Krim, Distinguin, Sportisse — en attente naturelle, pas de relance froide)
- SLOT LIBÉRÉ : **6** (Gauthier/Chift anticipé ; + 2026-05-29 : Mattioli/Thales, Rogers/Ledger, Zappellini/Crédit Agricole, Rice/HSBC, Erdem/Remedi)
- Canal alt email tenté puis libéré : 1 (Erdem)

**FUNNEL RÉEL** : 14 contacts en suivi actif (11 ENVOYÉ + 3 EN COURS HUMAIN). 6 SLOT LIBÉRÉ au total, 1 SORTI FUNNEL (Adnan), 1 SKIP (Houlès). Plafond « STOP nouveaux contacts » du 18/05 désormais échu — priorité avant tout nouvel envoi : **synchroniser le pipeline avec l'état réel** et statuer sur les 3 conversations chaudes.
...
- **2026-05-29 (v6.1)** : Reply Tracker auto-run. ⚠️ Pipeline non synchronisé depuis le 04/05 (586h). 5 passages **SLOT LIBÉRÉ** appliqués (>35j silence total, aucune réponse) : Mattioli/Thales, Rogers/Ledger, Zappellini/Crédit Agricole, Rice/HSBC (canal email jamais tenté → envisager avant abandon, cibles haute valeur) + Erdem/Remedi (canal alt email déjà tenté → abandon définitif). 3 alertes EN COURS HUMAIN stagnantes signalées (Iteanu, Hubert, Stefanini). Aucun statut géré par Audric modifié. Auteur : Reply Tracker (Claude Code).
