...
Objectif: 5 Design Partners signés. Statut actuel: **0/5 signés. 0 fil frais (Gesnouin passé SLOT LIBÉRÉ 13/09 après 60j silence — à revoir manuellement, cf. NB institutions publiques). 2 fils dormants (Alexandra Iteanu — reprise autorisée ; Gabriel Hubert — optionnel). 1 veille passive (Stefanini).**
...
|---|---|---|---|---|---|---|---|
| 2026-07-15 | **Philippe Gesnouin** | Inria | Directeur programme Santé numérique, co-pilote PEPR Santé numérique (France 2030), cofondateur Health Data Hub | Email audric@mandatia.eu, cc Bruno Sportisse | **SLOT LIBÉRÉ** | 2026-07-15 (email envoyé, version ultra-courte validée) | Slot libéré 2026-09-13 par tracker auto (silence 60j > seuil 35j). AUCUN canal alt possible (cc Sportisse interdit toute insistance). ⚠️ NB institutions publiques : leçon Sportisse (réponse à 2,5 mois) — cible haute valeur institutionnelle, Audric peut choisir de conserver en veille plutôt qu'abandon strict. Remplaçant à proposer par Outreach Radar W38. Intro via réponse Sportisse. Angle SANTÉ pur (mandat des agents dans les parcours de soin). Cible réputation/réseau institutionnel, pas DP commercial. |
...
Ajout tracker 2026-09-13 : Philippe Gesnouin (Inria) — SLOT LIBÉRÉ mécanique après 60j silence email. À réévaluer manuellement au regard de la leçon Sportisse (fenêtre 2-3 mois pour institutions publiques).

Aucune re-sollicitation prévue par défaut : le funnel reste recentré santé/assurance/juridique.
...
- Signés : **0 / 5**
- Fil frais : **0** (Gesnouin passé SLOT LIBÉRÉ 13/09 après 60j silence — voir NB institutions publiques)
- Fils dormants : 2 (Iteanu — reprise autorisée ; Hubert — optionnel)
- Envois planifiés : 3 (Hadj 16-17/07 ; Klaimee 20/07 ; MACSF semaine du 20/07) — ⚠️ jamais exécutés au 13/09
...
| **2026-07-16 ou 17** | Envoi LinkedIn Hadj (vérifier bouton Message avant). ⚠️ NON EXÉCUTÉ au 13/09. |
| **2026-07-20 (lundi)** | Envoi email Boutemadja/Klaimee (adresse validée Hunter ≥80 d'abord). ⚠️ NON EXÉCUTÉ au 13/09. |
| **Semaine du 20/07** | Courrier MACSF sociétaire. ⚠️ NON EXÉCUTÉ au 13/09. |
...
| **2026-07-31** | Si silence Hadj 14j → canal alt contact.dataprivacy@doctolib.com. (Sans objet : envoi jamais parti.) |
| **2026-08-31** | Jalon : template agent-sante-rgpd shippé + brouillon texte de référence mandat/responsabilité. |
| **2026-09-13** | Tracker auto : Gesnouin SLOT LIBÉRÉ (60j silence). ⚠️ Désynchro pipeline 60j détectée — resync manuel prioritaire. |
...
- **2026-09-13 (v7.2, tracker auto)** : Gesnouin passé SLOT LIBÉRÉ (silence email 60j > seuil 35j). ⚠️ À revoir manuellement au regard de la leçon Sportisse (institutions publiques répondent à 2-3 mois). Alertes tracker : 3 rappels PROPOSÉ >3j (Boutemadja, Hadj, MACSF — envois recalés au 20/07 jamais exécutés depuis 04/07), 3 alertes EN COURS HUMAIN stagnants (Sportisse 60j, Iteanu ~4 mois, Hubert ~4,5 mois). ⚠️ Désynchro pipeline détectée (~1424h depuis dernière MAJ) — resync manuel prioritaire recommandé avant d'agir sur ces alertes.
