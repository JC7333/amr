...
| 2026-04-14 | Erdem Yağan | Remedi Finance | Fintech healthcare BNPL (UK/TR) | LinkedIn (EN) puis email 23/04 | **SLOT LIBÉRÉ** | 2026-04-23 (email depuis audric@mandatia.eu) | **Slot libéré 2026-05-21** (37j silence LinkedIn + 28j silence email = silence total > 35j cumulés). Cible valide BNPL/AI Act Annex III pt 5 mais cooldown 90j jusqu'au 22/07. Remplaçant à proposer par Outreach Radar W21+. |
...
- Canal alt email tenté : 0 (Erdem passé SLOT LIBÉRÉ le 21/05)
- SLOT LIBÉRÉ 35j : 1 (Erdem Yağan / Remedi Finance, 2026-05-21)
- SLOT LIBÉRÉ anticipé : 1 (Gauthier Henroz / Chift)

**FUNNEL RÉEL** : 16 contacts en suivi actif (21 envoyés - Adnan SORTI - Gauthier libéré - Erdem libéré - Houlès SKIP). 3 conversations chaudes dont 1 RDV calé. **STOP nouveaux contacts jusqu'au 18/05** (priorité = cadrer correctement Iteanu + Hubert + Stefanini si elle répond).
...
| **2026-05-21 (aujourd'hui)** | **Erdem atteint 35j silence cumulé → SLOT LIBÉRÉ (acté).** |
...
**Jeudi 21/05** :
- Reply Tracker run sur pipeline non synchronisé depuis 16 jours (394h désynchro). Avertissement couche 3 émis.
- Erdem Yağan passé SLOT LIBÉRÉ automatiquement (37j silence LinkedIn + 28j silence email, deadline 18/05 annoncée par pipeline v6.0 atteinte).
- 3 alertes EN COURS HUMAIN stagnantes signalées : Stefanini (27j sans retour), Iteanu (21j depuis mail créneaux du 30/04, statut RDV 5-6/05 inconnu côté pipeline), Hubert (22j sans retour 2e message Audric).

---

## Changelog pipeline

- **2026-05-21 (v6.1)** : Erdem Yağan → SLOT LIBÉRÉ (35j cumulés atteints). Compteur funnel actif passé de 17 à 16. Tracker du jour signale désynchro pipeline 394h depuis v6.0. Auteur : Reply Tracker automatique (run du 21/05).
