...
- **2026-07-29 (tracker Reply Tracker)** : Run exécuté contre pipeline stale (324h depuis dernier commit du 15/07). Aucun statut changé automatiquement (Gesnouin à 14j, pas encore mûr pour SLOT LIBÉRÉ 35j). Alertes posées en PR : 3 rappels PROPOSÉ (Hadj, Boutemadja, MACSF — tous >9j après date d'envoi planifiée sans changement de statut), 3 alertes EN COURS HUMAIN stagnants (Sportisse, Iteanu, Hubert). Resync du pipeline avec l'état réel des envois requis avant d'agir sur ces alertes.
