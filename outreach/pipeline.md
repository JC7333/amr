...
- **2026-08-01 (tracker)** : Run Reply Tracker automatisé. ⚠️ Pipeline désynchronisé depuis ~17j (dernier commit 15/07 par JC7333) — alertes basées sur données potentiellement obsolètes. Aucun statut modifié par le tracker (Gesnouin seul en ENVOYÉ, 17j, cc Sportisse interdit tout canal alt ; aucun contact >35j). Alertes émises dans la PR : 3 rappels PROPOSÉ (Hadj planifié 16-17/07, Boutemadja planifié 20/07, MACSF semaine 20/07 — aucun tracé comme exécuté 12-16j après la date planifiée) ; 2 alertes EN COURS HUMAIN stagnants (Iteanu ~90j depuis appel de mai, Hubert ~94j depuis 29/04). Sportisse écarté de l'alerte EN COURS HUMAIN (action visible = cc email Gesnouin du 15/07, note pipeline "rien à faire de plus").
