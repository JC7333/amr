...
- **2026-07-28 (tracker run)** : aucun changement de statut, aucun slot libéré automatique. Alertes émises en PR : 3 rappels PROPOSÉ en retard (Hadj 11-12j, Klaimee 8j, MACSF ~8j vs planning du 15/07), 3 EN COURS HUMAIN stagnants (Sportisse redirection 13j — sans action attendue ; Iteanu ~85j — bloqueur reconfirmation appel ; Hubert ~90j — optionnel). Désynchro pipeline détectée : dernier commit sur ce fichier = 15/07 (295h / 12j sans mise à jour). Le batch planifié 15/07 (Hadj, Klaimee, MACSF) reproduit le pattern d'inertie du batch 04/07 (0 envoi en 11j).
