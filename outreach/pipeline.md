...
|---|---|---|---|---|---|---|---|
| 2026-07-15 | **Philippe Gesnouin** | Inria | Directeur programme Santé numérique, co-pilote PEPR Santé numérique (France 2030), cofondateur Health Data Hub | Email audric@mandatia.eu, cc Bruno Sportisse | **SLOT LIBÉRÉ** | 2026-07-15 (email envoyé, version ultra-courte validée) | Slot libéré 2026-09-07 par tracker (silence 54j sur ENVOYÉ, cc Sportisse interdit toute relance — "silence = silence" doc pipeline). Remplaçant à proposer par Outreach Radar W38. **Note manuelle Audric à vérifier** : le pipeline documente que "les institutions publiques répondent à 2-3 mois" (leçon Sportisse). Si Audric considère Gesnouin comme un cas institutionnel long, restaurer manuellement ENVOYÉ + note d'exception. Intro via réponse Sportisse. Angle SANTÉ pur. Cible réputation/réseau institutionnel, pas DP commercial. |
...
**Ajout 2026-09-07 (tracker)** : Philippe Gesnouin (Inria) — silence 54j sur email 15/07 (cc Sportisse). SLOT LIBÉRÉ mécanique. À vérifier manuellement par Audric si exception institutionnelle applicable.
...
- **2026-09-07 (tracker auto)** : Gesnouin ENVOYÉ 15/07 → SLOT LIBÉRÉ après 54j de silence (règle mécanique 35j). Cohérent avec la doctrine "silence = silence" de la ligne Gesnouin. NB : ce commit tracker intervient après 54j de désynchro pipeline — les envois planifiés (Hadj, Klaimee, MACSF) ne sont pas reflétés ici, à resynchroniser manuellement.
