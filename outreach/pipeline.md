...
- **2026-08-09 (tracker auto)** : Reply Tracker exécuté. ⚠️ DÉSYNCHRO 588h depuis dernier commit (v7.1, 15/07). Aucune transition automatique (Gesnouin ENVOYÉ 15/07 = 25j, seuil 35j non atteint ; canal alt interdit par cc Sportisse). Alertes signalées en PR : 2 EN COURS HUMAIN stagnants >3j (Iteanu ~100j, Hubert 102j) ; 3 rappels PROPOSÉ >3j (Boutemadja/Klaimee, Hadj, MACSF — envois recalés semaine 20/07, statut jamais mis à jour). Action prioritaire #1 : synchroniser le pipeline avec l'état réel des envois avant toute décision sur les alertes.
