...
| 2026-04-26 | Stanislas Polu (doublon supprimé) | — | — | — | — | — | — |
...
- Messages ENVOYÉS sans retour : 13 (en attente naturelle, pas de relance froide)
- Canal alt email tenté : 1 (Erdem) → silence → **SLOT LIBÉRÉ 25/05**
- SLOT LIBÉRÉ : 2 (Gauthier Henroz / Chift — anticipé 04/05 ; Erdem Yağan / Remedi — 25/05, canal alt épuisé)

**FUNNEL RÉEL** : 16 contacts en suivi actif (21 envoyés - Adnan SORTI - Gauthier libéré - Erdem libéré 25/05 - Houlès SKIP). 3 conversations chaudes dont 1 RDV calé. **STOP nouveaux contacts jusqu'au 18/05** (priorité = cadrer correctement Iteanu + Hubert + Stefanini si elle répond).
...
| 2026-05-18 | Erdem atteint 35j silence → **SLOT LIBÉRÉ effectif 25/05 (pas de réponse)** |
...
- **2026-05-25 (v6.1)** : Reply Tracker automatique. Erdem Yağan → SLOT LIBÉRÉ (silence total >35j : LinkedIn 14/04 + email 23/04, canal alt épuisé, seuil 18/05 dépassé sans réponse). Funnel actif 17 → 16. Auteur : Reply Tracker. ⚠️ Pipeline désynchronisé depuis le 04/05 (>48h) au moment du run — alertes EN COURS HUMAIN potentiellement stale.
