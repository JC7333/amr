...
Objectif: 5 Design Partners signés. Statut actuel: **0/5 signés. 0 fil frais (Gesnouin/Inria passé SLOT LIBÉRÉ le 14/09 à 61j — voir note institutionnelle). 2 fils dormants (Alexandra Iteanu — reprise autorisée ; Gabriel Hubert — optionnel). 1 veille passive (Stefanini).**
...
|---|---|---|---|---|---|---|---|
| 2026-07-15 | **Philippe Gesnouin** | Inria | Directeur programme Santé numérique, co-pilote PEPR Santé numérique (France 2030), cofondateur Health Data Hub | Email audric@mandatia.eu, cc Bruno Sportisse | **SLOT LIBÉRÉ (2026-09-14)** | 2026-07-15 (email envoyé, version ultra-courte validée) | Slot libéré 2026-09-14, silence 61j (>35j). Remplaçant à proposer par Outreach Radar W38+. ⚠️ ATTENTION cible institutionnelle : précédent Sportisse (réponse Inria à ~2,5 mois). Audric peut manuellement remettre en ENVOYÉ si stratégie "attente longue institution publique" jugée pertinente. Aucun canal alt possible (cc Sportisse interdit toute insistance). |
...
## Slots libérés (silence total >35j, purge appliquée 04/07, confirmée 15/07, MAJ 14/09)
...
**Ajout 2026-09-14 (Reply Tracker)** : Philippe Gesnouin (Inria) — libéré à 61j de silence [⚠️ note institutionnelle : cf. précédent Sportisse répondu à 2,5 mois — Audric peut réverter manuellement si stratégie "attente longue" jugée pertinente].
...
- Signés : **0 / 5**
- Fil frais : **0** (Gesnouin passé SLOT LIBÉRÉ 2026-09-14 — cf. note institutionnelle)
- Fils dormants : 2 (Iteanu — reprise autorisée ; Hubert — optionnel)
- Envois planifiés : 3 (Hadj 16-17/07 ; Klaimee 20/07 ; MACSF semaine du 20/07) — ⚠️ **AUCUN exécuté depuis 55+ jours, à statuer (envoyer ou SKIP)**
- Veille passive : 1 (Stefanini)
- Règle capacité : **3 fils chauds simultanés max**. Un envoi à la fois — le batch du 04/07 (4 envois planifiés d'un coup) n'a produit aucun envoi en 11 jours (ni sur les 60 jours suivants).
...
| **2026-09-14** | Reply Tracker : Gesnouin passé SLOT LIBÉRÉ (61j). Pipeline désynchronisé depuis 61j — resync urgent. |
...
- **2026-09-14 (v7.2, Reply Tracker auto)** : Gesnouin (Inria) passé `SLOT LIBÉRÉ` automatique à 61j de silence. ⚠️ Contexte institutionnel + précédent Sportisse (réponse Inria à 2,5 mois) — Audric peut manuellement revenir en `ENVOYÉ` si stratégie "attente longue institution publique" jugée pertinente. Aucune modification apportée aux statuts EN COURS HUMAIN / PROPOSÉ (compétence Audric). Alertes séparées émises dans la PR : (a) 3 EN COURS HUMAIN stagnants (Sportisse, Iteanu, Hubert), (b) 3 rappels PROPOSÉ largement dépassés (Klaimee, Hadj, MACSF — envois planifiés 07/2026 non exécutés depuis 55+ jours). **⚠️ Alerte majeure** : pipeline non synchronisé depuis 61 jours (dernière modif = v7.1 du 15/07). Risque de dérive stale sur toutes les alertes. Resync urgent avant toute action opérationnelle.
