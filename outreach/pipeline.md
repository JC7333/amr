...
Objectif: 5 Design Partners signés. Statut actuel: **0/5 signés. 0 fil frais (Gesnouin passé SLOT LIBÉRÉ mécanique 26/08 — à confirmer). 2 fils dormants (Alexandra Iteanu — reprise autorisée ; Gabriel Hubert — optionnel). 1 veille passive (Stefanini).**
...
|---|---|---|---|---|---|---|---|
| 2026-07-15 | **Philippe Gesnouin** | Inria | Directeur programme Santé numérique, co-pilote PEPR Santé numérique (France 2030), cofondateur Health Data Hub | Email audric@mandatia.eu, cc Bruno Sportisse | **SLOT LIBÉRÉ (mécanique 26/08, à confirmer)** | 2026-07-15 (email envoyé, version ultra-courte validée) | ⚠️ SLOT LIBÉRÉ appliqué mécaniquement (silence 42j >35j) mais à contre-courant de la leçon Sportisse : les institutions publiques répondent à 2-3 mois. Le cc Sportisse interdit toute relance. Audric à confirmer si fenêtre encore ouverte (auquel cas rétablir EN COURS HUMAIN passif) ou si abandon acté. Aucun remplaçant à proposer par Outreach Radar tant que non confirmé. |
...
## Slots libérés (silence total >35j, purge appliquée 04/07, confirmée 15/07, +1 mécanique 26/08)
...
**Philippe Gesnouin (Inria) — 2026-08-26 (mécanique 35j)** : appliqué automatiquement par le Reply Tracker malgré la leçon Sportisse. À confirmer par Audric : si la fenêtre 2-3 mois institution publique est jugée encore ouverte, rétablir EN COURS HUMAIN passif ; sinon abandon acté. Aucun remplaçant à proposer par Outreach Radar tant que non confirmé (cc Sportisse encore actif = risque réputation si Radar propose un autre contact Inria en parallèle).
...
- Signés : **0 / 5**
- Fil frais : **0** (Gesnouin passé SLOT LIBÉRÉ mécanique 26/08, à confirmer)
- Fils dormants : 2 (Iteanu — reprise autorisée ; Hubert — optionnel)
- Envois planifiés en retard : 3 (Hadj recalé 16-17/07 ; Klaimee recalé 20/07 ; MACSF recalé semaine 20/07) — aucun n'a été exécuté au 26/08
- Veille passive : 1 (Stefanini)
- Règle capacité : **3 fils chauds simultanés max**. Un envoi à la fois — le batch du 04/07 (4 envois planifiés d'un coup) n'a produit aucun envoi en 11 jours, puis 40+ jours de plus sans exécution.
...
| **2026-07-16 ou 17** | Envoi LinkedIn Hadj (vérifier bouton Message avant). — NON EXÉCUTÉ au 26/08 |
| **2026-07-20 (lundi)** | Envoi email Boutemadja/Klaimee (adresse validée Hunter ≥80 d'abord). — NON EXÉCUTÉ au 26/08 |
| **Semaine du 20/07** | Courrier MACSF sociétaire. — NON EXÉCUTÉ au 26/08 |
...
| **2026-07-31** | Si silence Hadj 14j → canal alt contact.dataprivacy@doctolib.com. — SANS OBJET (Hadj jamais envoyé) |
| **2026-08-26** | Tracker : Gesnouin SLOT LIBÉRÉ mécanique (à confirmer). 3 PROPOSÉ toujours en attente d'exécution. |
...
- **2026-08-26 (v7.2, tracker automatique)** : Reply Tracker exécuté après 42j de désynchro. Gesnouin passé SLOT LIBÉRÉ mécaniquement (silence 42j >35j) MAIS marqué "à confirmer" — la leçon Sportisse (institutions publiques répondent à 2-3 mois) s'applique ici aussi, Audric doit trancher avant qu'un remplaçant Inria soit proposé. Alertes EN COURS HUMAIN (Sportisse, Iteanu, Hubert) et rappels PROPOSÉ (Hadj, Klaimee, MACSF, tous ~37-40j en retard sur leur date d'envoi planifiée) portés en PR. Aucun statut EN COURS HUMAIN / PROPOSÉ / REPORTÉ / SORTI FUNNEL modifié par le tracker (règle absolue).
