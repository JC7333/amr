...
Objectif: 5 Design Partners signés. Statut actuel: **0/5 signés. 0 fil frais (Gesnouin auto-libéré par tracker 2026-08-25 — voir caveat). 2 fils dormants (Alexandra Iteanu — reprise autorisée ; Gabriel Hubert — optionnel). 1 veille passive (Stefanini).**
...
|---|---|---|---|---|---|---|---|
| 2026-07-15 | **Philippe Gesnouin** | Inria | Directeur programme Santé numérique, co-pilote PEPR Santé numérique (France 2030), cofondateur Health Data Hub | Email audric@mandatia.eu, cc Bruno Sportisse | **SLOT LIBÉRÉ (auto 2026-08-25)** | 2026-07-15 (email envoyé, version ultra-courte validée) | Auto-libéré par tracker 2026-08-25 : silence 41j >35j sur email cc Sportisse. ⚠️ **Caveat institutionnel** : Sportisse (même profil public) a répondu à 2,5 mois — la règle 35j est calibrée privé, elle est probablement prématurée ici. À reverter si Audric veut conserver le fil ouvert (rien à faire côté canal : le cc Sportisse interdit toute insistance de toute façon, silence = silence). Cible réputation/réseau, pas DP commercial : abandon ≠ perte de funnel DP. Remplaçant W35 à proposer par Outreach Radar seulement si Audric confirme la libération. |
...
**2026-08-25 (auto Tracker, à valider)** : Philippe Gesnouin (Inria) libéré par règle 35j (silence 41j sur email 15/07 cc Sportisse). ⚠️ Profil institutionnel identique à Sportisse — la leçon ci-dessus s'applique. Le tracker a appliqué la règle mécaniquement mais Audric doit trancher : reverter (garder le fil ouvert, quasi zéro coût car pas de canal alt possible) ou confirmer.
...
- Signés : **0 / 5**
- Fil frais : **0** (Gesnouin auto-libéré 2026-08-25 — voir caveat, à confirmer)
- Fils dormants : 2 (Iteanu — reprise autorisée ; Hubert — optionnel)
- Envois planifiés : 3 en attente d'exécution (Hadj 16-17/07 ; Klaimee 20/07 ; MACSF sem. 20/07). ⚠️ Pipeline désynchronisé 41j — statut réel de ces envois non vérifié.
...
| **2026-08-25** | Tracker : Gesnouin auto SLOT LIBÉRÉ (à valider), pipeline désynchronisé 41j (alerte majeure). |
...
- **2026-08-25 (v7.2, auto Tracker)** : ⚠️ pipeline désynchronisé 41j (dernier commit humain 15/07). Application mécanique de la règle 35j : Gesnouin ENVOYÉ → SLOT LIBÉRÉ. Caveat explicite ajouté (profil institutionnel = leçon Sportisse). Aucun autre changement de statut. Alertes émises par ailleurs : 3 EN COURS HUMAIN stagnants (Sportisse boucle close, Iteanu >110j, Hubert >115j), 3 PROPOSÉ >3j (Boutemadja/Klaimee, Hadj, MACSF — statut d'envoi réel inconnu par désynchro).
