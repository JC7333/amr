...
|---|---|---|---|---|---|---|---|
| 2026-07-15 | **Philippe Gesnouin** | Inria | Directeur programme Santé numérique, co-pilote PEPR Santé numérique (France 2030), cofondateur Health Data Hub | Email audric@mandatia.eu, cc Bruno Sportisse | **SLOT LIBÉRÉ (auto 2026-09-16)** | 2026-07-15 (email envoyé, version ultra-courte validée) | Slot libéré 2026-09-16 (silence 62j >35j depuis email 15/07). Remplaçant à proposer par Outreach Radar W38 prochain. ⚠️ ATTENTION : règle 35j calibrée privé — sur institution publique (Inria), fenêtre 2-3 mois possible (leçon Sportisse). Audric doit valider après resync pipeline. Pas de canal alt (cc Sportisse interdit toute insistance). |
...
**2026-09-16 (auto tracker)** : Philippe Gesnouin (Inria) — silence 62j depuis email 15/07. Remplaçant à proposer par Outreach Radar W38 prochain. ⚠️ À valider par Audric après resync pipeline : institution publique = fenêtre réponse 2-3 mois possible (cf. leçon Sportisse ci-dessus).
...
- **2026-09-16 (tracker auto)** : Passage mécanique SLOT LIBÉRÉ pour Gesnouin (Inria) — silence 62j (>35j) depuis email 15/07. ⚠️ Pipeline stale depuis 62 jours au moment du run — décision à valider par Audric après resync manuel. Rappel : règle 35j calibrée privé, institution publique = fenêtre 2-3 mois (cf. Sportisse). Tracker ne touche pas au compteur DP ni à la ligne Sportisse (EN COURS HUMAIN).
